      ...
      <div className="sticky top-0 z-20 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="flex items-center gap-1 px-4 py-2 flex-wrap">
          ...
          <ToolButton
            ...
            disabled={!selectionState.canUndo}
            title="Undo (Ctrl+Z)"
          />
          <ToolButton
            icon={Redo}
            onClick={() => editor.chain().focus().redo().run()}
            disabled={!selectionState.canRedo}
            title="Redo (Ctrl+Y)"
          />
          ...
          <ToolButton
            ...
            active={selectionState.isBulletList}
            title="Bullet List"
          />
          <ToolButton
            icon={ListOrdered}
            onClick={() => handleList("ordered")}
            active={selectionState.isOrderedList}
            title="Numbered List"
          />
          <ToolButton
            icon={Quote}
            onClick={() => editor.chain().focus().toggleBlockquote().run()}
            active={selectionState.isBlockquote}
            title="Quote"
          />
