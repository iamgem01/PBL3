...
const PlaceholderImage: React.FC<{ alt: string; className?: string }> = ({
  alt,
...
const LandingPage: React.FC = () => {
  ...
  const securityFeatures = [
    {
      icon: (
        <ShieldCheck className="w-8 h-10 text-blue-300" strokeWidth={1.3} />
      ),
    ...
    {
      icon: (
        <LockKeyhole className="w-8 h-10 text-pink-300" strokeWidth={1.3} />
      ),
    ...
    {
      icon: (
        <Fingerprint className="w-8 h-10 text-purple-300" strokeWidth={1.3} />
      ),
      title: "User Control",
  ...
  const documentFeatures = [
    {
      ...
      description:
        "Focus on your ideas — format and move blocks with one click.",
    ...
    },
    {
      ...
      description:
        "Invite teammates or friends to edit, comment, or view your docs in real time.",
  ...
  const testimonials = [
    {
      ...
      content:
        "SmartNotes has revolutionized how I organize my thoughts and project ideas. The AI categorization is incredible!",
      avatar: "SJ",
    },
    {
      name: "Mike Chen",
      ...
      content:
        "The search functionality is so fast and accurate. I can find any code snippet or meeting note in seconds.",
      avatar: "MC",
    },
    {
      name: "Emily Davis",
      role: "Designer",
      content:
        "Beautiful interface and intuitive design. It feels like the notes app I've always wanted.",
      avatar: "ED",
    },
  ];
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Your mind, organized. Your projects, simplified. All your notes,
            tasks, and plans are here.
          </p>
            ...
            {securityFeatures.map((feature, index) => (
              <Card key={index} borderColor="purple">
                <div className="p-6 flex justify-between items-center">
                  ...
                  {/* Cột 2: Icon */}
                  <div className="flex-shrink-0 ml-4">{feature.icon}</div>
                </div>
              </Card>
            ))}
          </div>
          ...
          <div className="border glow-border rounded-lg p-8 bg-white dark:bg-slate-900">
            ...
            <div className="max-w-3xl mx-auto text-center mb-10 text-gray-800 dark:text-gray-300">
              ...
              <p className="text-m leading-relaxed">
                Aeternus lets you create beautiful documents in seconds — from
                class notes to project plans. Type, drag, and format freely with
                our block system. Everything stays neat, synced, and ready to
                share
              </p>
            </div>
            {/* Cards features */}
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 justify-between font-inter">
              {documentFeatures.map((feature, idx) => (
                ...
                >
                  ...
                  <div className="ml-auto opacity-40 mt-1">{feature.icon}</div>
                </div>
              ))}
            </div>
        ...
        <div className=" w-full place-content-center px-4">
          ...
          <div className="text-center max-w-4xl mx-auto mb-8 px-4">
            ...
            <p className="text-muted-foreground text-base">
              Sync tasks, attach files, and update notes automatically without
              switching tabs.
            </p>
          </div>
      ...
      <section className="flex flex-col items-center bg-white py-16 px-4">
        ...
        <div className="text-center mb-20 px-6">
          ...
          <p className="text-sm text-gray-500 max-w-xl mx-auto">
            Powerful <span className="text-purple-600">features</span> designed
            to make note-taking effortless and finding information instant.
          </p>
        </div>
        <div className="w-full max-w-7xl mx-auto flex flex-col items-center gap-y-20 font-inter">
          ...
          >
            <ContentPlaceholder>
              ...
              >
                <p className="text-center text-gray-400 italic"></p>
                <img
          ...
          <div className="bg-blue-50 p-8 md:p-12 rounded-lg shadow-lg border border-blue-100 flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Craft your perfect trip with shared notes.
              </h2>
              <p className="text-gray-600 mb-6">
                Use Aeternus to collaboratively plan itineraries, budgets, and
                packing lists with friends and family. Real-time updates keep
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Built for teams and individuals who value clarity and efficiency.
            </p>
          </div>
          ...
          <div className="mt-16 bg-white p-6 rounded-lg shadow-lg border border-gray-200 max-w-4xl mx-auto">
            <PlaceholderImage
              alt="[Image comparing features]"
              className="w-full h-64 bg-gray-100 rounded-md flex items-center justify-center text-gray-500"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-gray-700">
              See what our users have to say about Aeternus
            </p>
          </div>
              ...
              >
                <div className="flex items-center mb-4 space-x-1">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className="h-5 w-5 text-purple-300 fill-current"
                    />
                  ))}
                </div>
                <p className="text-gray-800 mb-6 italic text-sm leading-relaxed">
                  "{t.content}"
                </p>
