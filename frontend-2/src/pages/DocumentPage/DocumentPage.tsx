...
export default function DocumentPage() {
  ...
  const handleShareToggle = useCallback(async () => {
    ...
    try {
      if (isShared) {
        ...
        setIsShared(true);
        alert(
          "✅ Collaboration enabled! Use the Invite button to share with specific users."
        );
      }
    } catch (error: any) {
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <main
        className={`transition-all duration-300 flex-1 flex flex-col overflow-hidden ${
          collapsed ? "ml-20" : "ml-64"
        }`}
      >
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            {!isShared ? (
              <button
                ...
                disabled={isSharing}
                className="flex items-center gap-2 px-4 py-2 border-2 border-blue-500 text-blue-600 rounded-lg hover:bg-blue-50 transition-all"
              >
                {isSharing ? (
              ...
              <>
                ...
                <button
                  onClick={handleShareToggle}
                  disabled={isSharing}
                  className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-muted"
                >
            ...
            <div className="bg-card border border-border rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold flex items-center gap-2">
                  <UserPlus size={20} className="text-blue-500" /> Invite
                  Collaborator
                </h3>
                <button
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      disabled={isInviting}
                      className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex justify-center gap-2"
                    >
