...
app.put(
  ...
  async (req, res) => {
    try {
      ...
      console.log(
        `✅ Admin ${req.user.email} changed ${user.email} role to ${role}`
      );
      res.json({ user });
    } catch (error) {
...
app.put(
  ...
  async (req, res) => {
    try {
      ...
      console.log(
        `✅ Admin ${req.user.email} updated ${user.email} permissions`
      );
      res.json({ user });
    } catch (error) {
...
app.put(
  ...
  async (req, res) => {
    try {
      ...
      console.log(
        `✅ Admin ${req.user.email} ${isActive ? "activated" : "deactivated"} ${
          user.email
        }`
      );
      res.json({ user });
